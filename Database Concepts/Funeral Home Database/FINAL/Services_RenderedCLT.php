...
<h2>Please Provide a ContractID to create a report on.</h2>
<table>
<form action="Services_RenderedSRV.php" method="get">
<tr>
<td>ContractID lookup:</td><td><input type="number" name="id" ></td>
</tr>
...
<img src="desktop.gif" style="left: 0;bottom: 0;height: 100%;">
<div id="footer">
