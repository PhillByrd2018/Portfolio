...
<body>
	...
	<div id="container">
	  <div id="nav">
				...
				<h2 style="text-align: center;vertical-align: middle;line-height: 80px;">Add Entry</h2>
...
<table>
<form action="addDeadPersonSRV.php" method="get">
...
<tr>
<td>Date of Death:</td><td><input type="date" name="DOD" min="0" max="100"/></td>
</tr>
...
<img src="fidget.gif" style="left: 0;bottom: 00;height: 100%;">
<div id="footer">
