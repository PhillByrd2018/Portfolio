...
<h3>Please Fill out the Service Information</h3>
<table>
<form action="addServiceSRV.php" method="get">
...
<tr>
<td>Service Type:</td><td><input type="radio" name="Service_Type" value="Burial"/>Burial
<input type="radio" name="Service_Type" value="Cremation"/>Cremation</td>
</tr>

<tr>
<td>Service Official:</td><td><input type="text" name="Service_Official"/></td>
</tr>

<tr>
<td>Service Location:</td><td><input type="text" name="Service_Location"/></td>
</tr>

<tr>
<td>Service Date:</td><td><input type="date" name="Service_Date"/></td>
</tr>
...
<div id="footer">
			<img src="thinking.gif" style="position: fixed;left: 0;bottom: 0;height: 40%;">
