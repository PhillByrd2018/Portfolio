...
<div id="container">
	  <div id="nav">							YOU ARE THHHEEEE CUTESTTTTT
...
<table>
<form action="addCauseSRV.php" method="get">
...
<tr>
<td>Cause of Death: </td><td><input type="text" name="C_O_D"/></td>
</tr>

<tr>
<td>Suspected Foul: </td><td><input type="text" name="Foul_Play"/></td>
</tr>
