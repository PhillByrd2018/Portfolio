...
<body>
	...
	<div id="container">
	  <div id="nav">
				...
				<h2 style="text-align: center;vertical-align: middle;line-height: 80px;">Add a Next of Kin</h2>
...
<h3>Please Fill out the Next of Kin Information</h3>
<table>
<form action="addNextofKinSRV.php" method="get">
...
<tr>
<td>
<button class="btn btn-info" type="submit">Submit Entry</button>
</td>
</tr>
</form>
</table>
...
<div id="footer">
			<img src="vr.gif" style="position: fixed;left: 0;bottom: 0;height: 40%;">
