...
function draw() {
	...
	function renderMarioxl(){
		if (Mario.x >= 0 && Mario.moving == "left") {
		...
		}else if(Mario.x >= 0 && Mario.moving == "no"){
			Mario.moving = "left";
	...
	function renderMarioxr(){
		if (Mario.x < 550 && Mario.moving == "right") {
		...
		}else if(Mario.x > 0 && Mario.x < 550 && Mario.moving == "no"){
			Mario.moving = "right";
	...
	document.body.onkeydown = function(e) {  // listen for a key
    	...
    	if(keycode === 37 && Mario.moving == "no") {  
        	Mario.timer = setInterval(render2, Mario.timerInterval+ 75);
    	}
    	if(keycode === 39 && Mario.moving == "no") {  
        	Mario.timer = setInterval(render3, Mario.timerInterval+ 75);
    	}
	}
